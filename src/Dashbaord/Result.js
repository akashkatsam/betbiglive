// import statImg from "./statImg.jpg";
    ...
    <div>
      ...
      <div className="row">
        ...
        <div className="col-10">
          ...
          <div className="row">
            <div className="col-6">
              <div class="details-banner pt-60 pb-60">
                <div class="container">
                  <div class="details-wrapper">
                    <div class="scoreboard-head">
                      <span>
                        <img
                          src="assets/img/table/details/scoreboard.png"
                          alt="img"
                        />
                      </span>
                      <span class="text-base">Scoreboard</span>
                    </div>
                    <div class="banner-wrapper owl-theme owl-carousel">
                      <div class="details-img">
                        <div class="details-progress">
                          <div class="detail-progress-items">
                            <div class="bar1">
                              <div class="changchun">
                                <img
                                  src="assets/img/table/details/changchun.png"
                                  alt="img"
                                />
                              </div>
                            </div>
                          ...
                          <div class="detail-progress-items details-middle-items">
                            <a href="#0" class="live">
                              Break 1'45
                            </a>
                            <div class="detaisl-middle-circle-wrap d-flex align-items-center">
                              <h3 class="gra">1</h3>
                              <div class="bar-middle-circle">
                                <svg
                                  width="100"
                                  height="100"
                                  viewBox="0 0 100 100"
                            ...
                            <div class="matchfixing-box">
                              <a href="#0" class="match">
                                <span>
                                  <img
                                    src="assets/img/table/details/changchun.png"
                                    alt="img"
                              ...
                              <a href="#0" class="match">
                                ...
                                <span class="reds">
                                  <img
                                    src="assets/img/table/details/red.png"
                                    alt="img"
                                  />
                                </span>
                              </a>
                              <a href="#0" class="match">
                                <span>
                                  <img
                                    src="assets/img/table/details/zall.png"
                                    alt="img"
                                  />
                                </span>
                                <span>10</span>
                          ...
                          <div class="detail-progress-items detail-last-items">
                            <div class="bar1">
                              <div class="changchun">
                                <img
                                  src="assets/img/table/details/zall.png"
              ...
              {/* <table class="table">
                <thead class="thead-dark">
                  <tr>
                    ...
                    <th scope="col">YEt to bat: 309/6</th>
                    <th scope="col">Pakistan</th>
                  </tr>
                </thead>
                <thead>
                  <tr>
                    <th scope="col" class=" body-items2">
                      Scorecard
                    </th>
                    <th scope="col" class=" body-items2">
                      Statistics
