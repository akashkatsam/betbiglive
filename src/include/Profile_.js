...
export default function Profile() {
  ...
  const [bankbtnright, setBankbtnright] = useState("btnactright");
  ...
  const handleChange1 = (event) => {
    ...
    if (event.target.value === "upiright") {
      setUpiright("d-block");
      setBankright("d-none");
      setUpiright("btnactright");
      setBankbtnright("btnact1right");
    } else {
      setUpiright("d-none");
      setBankright("d-block");
      setBankbtnright("btnactright");
      setUpibtnright("btnact1right");
    }
  };
                    ...
                    <div class="row">
                      <div class="selector ">
                        <div class="selecotr-item">
                          ...
                          <label
                            for="radio1"
                            class={`selector-item_label ${bank}`}
                          >
                            Bank
                          </label>
                        </div>
